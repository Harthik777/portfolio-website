...
export default function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 glass border-b border-gray-200 dark:border-gray-800 shadow-lg backdrop-blur-md">
      <nav className="flex items-center justify-between px-6 py-4 md:py-5 lg:px-12 relative" aria-label="Global">
        <div className="flex items-center gap-4">
          <span className="text-xl font-extrabold tracking-tight gradient-text select-none">Harthik M V</span>
        </div>
