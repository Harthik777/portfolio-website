          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="card-interactive-premium animate-fade-in-scale mx-auto max-w-4xl p-12 text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                ...
                real-world problems. I am currently pursuing my B.Tech in
                Computer Science and Engineering (Artificial Intelligence) at
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-2 sm:gap-4">
                <div className="flex items-center space-x-2 rounded-full bg-indigo-100 px-3 py-2 dark:bg-indigo-900/50 sm:px-4">
                  <div className="h-2 w-2 rounded-full bg-indigo-500"></div>
                  <span className="text-xs font-medium text-indigo-700 dark:text-indigo-300 sm:text-sm">
                    Research Leadership
                  </span>
                </div>
                <div className="flex items-center space-x-2 rounded-full bg-purple-100 px-3 py-2 dark:bg-purple-900/50 sm:px-4">
                  <div className="h-2 w-2 rounded-full bg-purple-500"></div>
                  <span className="text-xs font-medium text-purple-700 dark:text-purple-300 sm:text-sm">
                    AI/ML Engineering
                  </span>
                </div>
                <div className="flex items-center space-x-2 rounded-full bg-pink-100 px-3 py-2 dark:bg-pink-900/50 sm:px-4">
                  <div className="h-2 w-2 rounded-full bg-pink-500"></div>
                  <span className="text-xs font-medium text-pink-700 dark:text-pink-300 sm:text-sm">
                    Data Science
                  </span>
                </div>
              </div>
                  ...
                  <div className="space-y-6">
                    <div className="rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 p-4 dark:from-purple-900/20 dark:to-pink-900/20">
                      ...
                      <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                        First author on publication accepted at IEEE TENCON
                        2025, the flagship conference of IEEE Region 10 (Asia
                        Pacific), for research on Machine Learning Framework for
                        Data-Scarce Regression using SMOGN.
                      </p>
                    </div>
                    ...
                    <div className="rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 p-4 dark:from-purple-900/20 dark:to-pink-900/20">
                      ...
                      <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                        Won MAHE Bengaluru's university-wide 'RoboRun'
                        competition and selected for MIT Bengaluru's official
                        TechTatva team.
                      </p>
                    </div>
                    ...
                    <div className="rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 p-4 dark:from-purple-900/20 dark:to-pink-900/20">
                      ...
                      <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                        Finalist in the international competition held in Abu
                        Dhabi, UAE.
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="space-y-6">
                    <div className="rounded-lg bg-gradient-to-r from-pink-50 to-indigo-50 p-4 dark:from-pink-900/20 dark:to-indigo-900/20">
                      ...
                      <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                        Leading a student branch comprising 11 IEEE technical
                        societies, organizing interdisciplinary events and
                        fostering collaboration among diverse technical
                        chapters.
                      </p>
                    </div>
                    ...
                    <div className="rounded-lg bg-gradient-to-r from-pink-50 to-indigo-50 p-4 dark:from-pink-900/20 dark:to-indigo-900/20">
                      ...
                      <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                        Leading IEEE Student Branch activities and serving as
                        liaison with IEEE CS Society.
                      </p>
                    </div>
                    ...
                    <div className="rounded-lg bg-gradient-to-r from-pink-50 to-indigo-50 p-4 dark:from-pink-900/20 dark:to-indigo-900/20">
                      ...
                      <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                        Leading 5-person outreach team, securing partnerships
                        and organizing industry visits.
                      </p>
                    </div>
                  </div>
                </div>
