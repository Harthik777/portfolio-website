    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            {/* Main action buttons */}
            <div className="flex w-full max-w-md flex-col items-center gap-4 sm:max-w-none sm:flex-row sm:gap-6">
              <Link
                href="/projects"
            ...
            {/* Social links */}
            <div className="flex w-full max-w-md flex-col items-center gap-3 sm:max-w-none sm:flex-row sm:gap-4">
              <a
                href="https://www.linkedin.com/in/harthik-mv/"
                target="_blank"
                rel="noopener noreferrer"
                className="mobile-touch-target group inline-flex w-full items-center justify-center gap-2 rounded-full border border-blue-300 bg-blue-50/80 px-6 py-3 text-sm font-semibold text-blue-700 backdrop-blur-sm transition-all hover:bg-blue-100 hover:shadow-lg dark:border-blue-600 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/40 sm:w-auto"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mobile-touch-target group inline-flex w-full items-center justify-center gap-2 rounded-full border border-gray-300 bg-gray-50/80 px-6 py-3 text-sm font-semibold text-gray-700 backdrop-blur-sm transition-all hover:bg-gray-100 hover:shadow-lg dark:border-gray-600 dark:bg-gray-800/80 dark:text-gray-300 dark:hover:bg-gray-700 sm:w-auto"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-x-6">
            <Link
              href="/contact"
              className="mobile-touch-target w-full rounded-full bg-white px-8 py-4 text-center text-sm font-semibold text-indigo-600 shadow-lg transition-all hover:scale-105 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 sm:w-auto"
            >
              Get in Touch
            </Link>
            <Link
              href="/projects"
              className="mobile-touch-target w-full text-center text-sm font-semibold leading-6 text-white hover:text-indigo-100 sm:w-auto"
            >
