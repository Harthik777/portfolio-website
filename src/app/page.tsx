          ...
          >
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="group inline-flex items-center gap-2 rounded-full border border-blue-300 bg-blue-50/80 px-6 py-3 text-sm font-semibold text-blue-700 backdrop-blur-sm transition-all hover:bg-blue-100 hover:shadow-lg dark:border-blue-600 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/40"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 rounded-full border border-gray-300 bg-gray-50/80 px-6 py-3 text-sm font-semibold text-gray-700 backdrop-blur-sm transition-all hover:bg-gray-100 hover:shadow-lg dark:border-gray-600 dark:bg-gray-800/80 dark:text-gray-300 dark:hover:bg-gray-700"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
