const skills = {
  ...
  'Machine Learning & AI': {
    ...
    bgGradient:
      'from-pink-50 to-indigo-50 dark:from-pink-900/20 dark:to-indigo-900/20',
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9-9a9 9 0 00-9 9m0 0a9 9 0 009-9"
        />
      </svg>
    ),
                ...
                >
                  ...
                  <div className="relative">
                    <div className="mb-6 flex items-center gap-4">
                      <div
                        className={`flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r ${skillData.gradient}`}
                      >
                        {skillData.icon}
                      </div>
                    ...
                    <div className="space-y-3">
                      <div
                        className={`rounded-lg bg-gradient-to-r ${skillData.bgGradient} p-4`}
                      >
                        <div className="flex flex-wrap gap-2">
                          {skillData.items.map(skill => (
                            <span
                              key={skill}
                              className="inline-flex items-center rounded-lg border border-gray-200/50 bg-white/80 px-3 py-2 text-sm font-medium text-gray-800 shadow-sm transition-all duration-200 hover:scale-105 hover:bg-white hover:shadow-md dark:border-gray-600/50 dark:bg-gray-700/80 dark:text-gray-200 dark:hover:bg-gray-700"
                            >
                              {skill}
                            </span>
                          ))}
