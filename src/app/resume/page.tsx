          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="card-interactive-premium animate-fade-in-scale mx-auto max-w-4xl p-12 text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                ...
                , feel free to explore the rest of this portfolio or{' '}
                <Link
                  href="/contact"
            ...
            {/* Experience Section */}
            <div className="card-interactive-premium animate-fade-in-scale mx-auto mt-16 p-8">
                    ...
                    <div className="ml-4 flex-1">
                      ...
                      <div className="mt-3">
                        <p className="text-sm font-semibold text-gray-900 dark:text-white">
                          A Machine Learning Framework for Data-Scarce
                          Regression using SMOGN with Joint Hyperparameter
                          Optimization: A Case Study with Cricket Performance
                          Prediction
                        </p>
                        <div className="mt-2 flex items-start">
                          ...
                          <p className="ml-2 text-sm text-gray-600 dark:text-gray-300">
                            ...
                            on publication accepted at{' '}
                            <span className="font-semibold">
                              IEEE TENCON 2025
                            </span>{' '}
                            (flagship conference of IEEE Region 10, Asia
                            Pacific)
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="ml-4 flex-1">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                            Supervisors: Soumyashree M. Panchal and Dr. Vishnu
                            Srinivasa Murthy Y
                          </p>
                        </div>
                      </div>
                      <div className="mt-3">
                        <p className="text-sm font-semibold text-gray-900 dark:text-white">
                          Performance Degradation of Deep and Traditional
                          Machine Learning Models Under Market Volatility: An
                          Inter-Day Stock Trend Comparison
                        </p>
                        <div className="mt-2 flex items-start">
                          <div className="flex-shrink-0">
                            <svg
                          ...
                          <p className="ml-2 text-sm text-gray-600 dark:text-gray-300">
                            ...
                            (the flagship IEEE India Council conference in
                            India)
                          </p>
                        </div>
                      </div>
                ...
                <div className="rounded-lg bg-white p-6 shadow transition-all duration-300 hover:shadow-xl dark:bg-gray-800">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4 flex-1">
                      ...
                      <div className="mt-3">
                        <p className="text-sm font-semibold text-gray-900 dark:text-white">
                          An Efficient and Explainable Transformer Framework for
                          Unified Summarization and Question Answering
                        </p>
                        <div className="mt-2 flex items-start">
                          <div className="flex-shrink-0">
                            <svg
                          ...
                          <p className="ml-2 text-sm text-gray-600 dark:text-gray-300">
                            ...
                            <span className="font-semibold">
                              ...
                              Intelligence, Computation, Communication, and
                              Network Security (AICCoNS 2026)
                            </span>
                          </p>
                        </div>
                      </div>
