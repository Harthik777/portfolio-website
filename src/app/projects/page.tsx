...
const projects = [
  {
    ...
    githubLink: 'https://github.com/Harthik777/SmartNLPAssistant',
    date: '10/2025',
  },
  {
    title: 'SustainAI: Carbon-Aware Air Quality Prediction Platform',
    description:
      'Developed an environmentally-conscious machine learning platform for air quality prediction with integrated carbon footprint tracking using CodeCarbon. Implemented multiple regression models (Random Forest, XGBoost, LSTM) with comprehensive explainability features using SHAP and LIME. The platform monitors and reports the carbon emissions of model training and inference, promoting sustainable AI practices. Features include real-time air quality predictions, model interpretability dashboards, carbon emission metrics, and comparative analysis of model performance vs. environmental impact.',
    tags: [
  ...
  },
  {
    ...
    description:
      'Accepted for Presentation at IEEE TENCON 2025 (Malaysia, October 2025). This research focuses on applying SMOGN for data augmentation in regression tasks within data-scarce sports analytics, specifically cricket performance prediction, to enhance model accuracy and reliability.',
    tags: [
      'Publication',
      'SMOGN',
      'Regression',
